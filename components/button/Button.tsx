...
export default function Button({href, text, variant="normal", onClick}: ButtonProps) {
    ...
    let className = "relative cut-button __press-drop w-full h-full text-xl min-w-full sm:min-w-fit sm:max-w-fit bg-primary-200 hover:bg-primary-400 font-bold border-white text-primary-900 cursor-pointer flex justify-center items-center transition-colors duration-300"
