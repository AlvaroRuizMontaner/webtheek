...
export default function Button({href, text, variant="normal", onClick}: ButtonProps) {
    ...
    let className = "text-xl px-8u py-2u max-w-[214px] sm:max-w-fit rounded-lg bg-primary-400 hover:bg-primary-700 border-2 border-primary-500 text-white cursor-pointer flex justify-center items-center transition-colors duration-300"
