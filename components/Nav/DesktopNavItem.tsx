...
export default function DesktopNavItem({name, url}: NavItem) {
  ...
  return (
    <div className={`cursor-pointer hover:text-accent-500 text-primary-100 h-full py-8u text-lg w-max flex items-center ${isPath && "border-b-4 !text-accent-300 border-accent-300"}`}>
        {(url || url === "") ? (
