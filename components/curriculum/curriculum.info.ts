...
export const seccionCuerpoCentralExperienceInfo: seccionCuerpocentralInfoType = {
    titleIcon: {
...
export const seccionCuerpoCentralProyectosInfo: seccionCuerpocentralInfoType = {
    titleIcon: {
