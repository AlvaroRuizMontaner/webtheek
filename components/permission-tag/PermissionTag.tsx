...
export default function PermissionTag({isManager, permissionLevel}: PermissionTagProps) {
    ...
    const numberTagClassNames: Record<number, string> = {
      1: "bg-primary-200 text-accent-700 border-t-primary-500 border-b-primary-500",
      2: "bg-primary-200 text-accent-warning-700 border-t-primary-500 border-b-primary-500",
      3: "bg-primary-200 text-accent-danger-700 border-t-primary-500 border-b-primary-500",
    }
