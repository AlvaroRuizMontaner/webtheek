...
export default function EditableMain({themeName, main, bodyChildIndex, pageNumber, infoChildIndex, handleInfoOnFocus, handleInfoOnBlur, infoChild, isEditable}: EditableMainProps) {
